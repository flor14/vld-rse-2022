...
.large[ ### Vive la différence - research software engineers | Apr **2022** ]
]
...
library(tweetrmd)
tweet_screenshot("https://twitter.com/RLadiesBA/status/868517119528501248?s=20&t=36flSCmHWnCDnULDIzSDHw")
```
...
## One thing leaves to another

```{r ghtwcom2, echo=FALSE, fig.align="center", out.width=600}
...
```{r ghtw222, echo=FALSE, fig.align="center", message=FALSE, warning=FALSE, out.width=450}
library(tweetrmd)
tweet_screenshot("https://twitter.com/cantoflor_87/status/1038005760385536001?s=20&t=Vx0P3p1So0Qjkt-vjhSaUA")
```

.footnote[[Tweet](https://twitter.com/cantoflor_87/status/1038005760385536001?s=20&t=Vx0P3p1So0Qjkt-vjhSaUA)]
...
```{r ghtw11, echo=FALSE, fig.align="center", message=FALSE, warning=FALSE, out.width=450}
library(tweetrmd)
tweet_screenshot("https://twitter.com/RLadiesBA/status/1299834952578674689?s=20&t=36flSCmHWnCDnULDIzSDHw")
```

.footnote[[Tweet](https://twitter.com/RLadiesBA/status/1299834952578674689?s=20&t=36flSCmHWnCDnULDIzSDHw)]
...
```{r ghtw4, echo=FALSE, fig.align="center", message=FALSE, warning=FALSE, out.width=450}
library(tweetrmd)
tweet_screenshot("https://twitter.com/ReproHack/status/1260125107667820544?s=20&t=Vx0P3p1So0Qjkt-vjhSaUA")
```
]
...
.footnote[[Tweet](https://twitter.com/ReproHack/status/1260125107667820544?s=20&t=Vx0P3p1So0Qjkt-vjhSaUA)]
...
We need greater career opportunities to switch to data science / software development areas.

---

class: middle

Networking and interaction with likeminded people in different communities was key to helping me find the important sources of information.
---
...
knitr::include_graphics("images/HealthyLeadership.jpg")
```
